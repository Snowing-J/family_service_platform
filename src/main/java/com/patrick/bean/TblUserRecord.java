...
public class TblUserRecord implements Serializable {
    ...
    public TblUserRecord setTblRole(TblRole tblRole) {
    ...
    public TblUserRecord setTblDept(TblDept tblDept) {
    ...
    public TblUserRecord setTblCompany(TblCompany tblCompany) {
