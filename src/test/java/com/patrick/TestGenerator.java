...
public class TestGenerator {
    ...
    public void testGenerator() {
        ...
        globalConfig.setAuthor("lian")  //输出的目录有问题
                .setOutputDir("C:\\Users\\15583\\Desktop\\output")//设置输出路径
        ...
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://localhost:3307/family_service_platform?serverTimezone=UTC")
                .setUsername("root").setPassword("tiger");
        ...
        packageConfig.setParent("com.patrick").setMapper("mapper")
